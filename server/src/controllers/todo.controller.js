...
const createTodos = async (req, res) => {
  try {
    ...
    return response(res, { todo }, 'Todo Created Successfully', 201)
  } catch (err) {
...
const updateTodos = async (req, res) => {
  try {
    ...
    return response(res, { todo }, 'Todo updated Successfully', 200)
  } catch (err) {
    throw error({ message: err.message, status: 'failure' }, err.message)
  }
}
...
const fetchTodosByUser = async (req, res) => {
  try {
    ...
    if (completed) {
      ...
      whereCondition = { ...whereCondition, completed }
    }
...
const deleteTodo = async (req, res) => {
  try {
    ...
    return response(res, { todo }, 'Todo Deleted Successfully', 200)
  } catch (err) {
    throw error({ message: err.message, status: 'failure' }, err.message)
  }
}
